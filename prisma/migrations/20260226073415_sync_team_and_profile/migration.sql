-- CreateEnum
CREATE TYPE "PostStatus" AS ENUM ('TASLAK', 'BEKLEYEN_ONAY', 'ONAYLANDI', 'YAYINLANDI', 'HATA');

-- CreateEnum
CREATE TYPE "MediaType" AS ENUM ('RESIM', 'VIDEO', 'SES', 'BELGE');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'EDITOR', 'APPROVER');
...
CREATE TABLE "Team" (
    ...
    "clinicAddress" TEXT,
    "brandVoice" TEXT,
    "brandColors" TEXT[] DEFAULT ARRAY['#8b5cf6', '#1e293b']::TEXT[],
...
CREATE TABLE "Post" (
    ...
    "status" "PostStatus" NOT NULL DEFAULT 'TASLAK',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
